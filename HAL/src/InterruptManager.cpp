...
bool InterruptManager::RegisterInterrupt(IRQn eIRQn,ISR pISR )
{
	...
	if(pISR) NVIC_Config(eIRQn,15,0);
...
void InterruptManager::Disable_Interrupt(IRQn eIRQn)
{
...
void InterruptManager::Enable_Interrupt(IRQn eIRQn)
{
	if( (eIRQn>= InterruptManager::EXTI5_IRQHandler ) && (eIRQn<= InterruptManager::EXTI9_IRQHandler )  )
		 eIRQn = InterruptManager::EXTI9_5_IRQHandler;
	else if( (eIRQn>= InterruptManager::EXTI10_IRQHandler ) && (eIRQn<= InterruptManager::EXTI15_IRQHandler )  )
...
void InterruptManager::NVIC_Config(IRQn eIRQn, u8 Priority, u8 SubPriority)
{
